...
import { SocketEventHandler, SocketMessageTypes, TelepartyClient } from "teleparty-websocket-lib";
...
export const ChatProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const createChat  = () => {
    ...
    const res = client?.createChatRoom('Manish').then((roomId) => {
  ...
  return (
    <ChatContext.Provider value={{ client, isConnected, messages, isCreatingRoom, createChat, roomId, sendMessage, joinRoom }}>
      {children}
